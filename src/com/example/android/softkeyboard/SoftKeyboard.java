...
import com.example.android.softkeyboard.SelectPasswordView.KeyboardServiceInterface;
		...
		KeyboardView.OnKeyboardActionListener
{
	...
	{
		parent = (FrameLayout) getLayoutInflater().inflate(
				R.layout.view_parent, null);
	...
	{
		// TODO
		if (primaryCode == Constants.BECLOUD_KEYCODE)
		{
			addPasswordView();
			Log.d("DEBUG", primaryCode + " onKey");
		}
	...
	public void addKeyboard()
	{
		...
		mInputView = (LatinKeyboardView) getLayoutInflater().inflate(
				R.layout.view_keyboard, null);
		mInputView.setOnKeyboardActionListener(this);
		mInputView.setKeyboard(mQwertyKeyboard);
		parent.addView(mInputView);
	}
	...
	public void addPasswordView()
	{
		...
		{
			removeAllViews();
			SelectPasswordView view = new SelectPasswordView(this,getAppName(),
					new KeyboardServiceInterface()
					{
						@Override
	...
	{
		//TODO use becloud method
		return MyKeyboardController.getAppNameByPackage(this
